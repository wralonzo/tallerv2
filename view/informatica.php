    ...
    if (empty($id)) {
      ...
      if (empty($Detalle)) {
        ...
        if ($result > 0) {
          ...
          $query = "INSERT INTO costo(idNombre,Detalle,Precio,fecha) values ('$Nombre','$Detalle', '$Precio','$fecha')";
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo Date('Y-m-d') ?>" class="form-control" placeholder="Ingrese fecha" name="fecha" id="fecha">
                  </div>
                </div>
